...
public sealed partial class OpenAIProvider : BaseLLMProvider
{
    ...
    public OpenAIProvider(IOptionsMonitor<LLMProviderOptions> options, ITokenEstimatorFactory tokenEstimatorFactory)
        : base(
            options.Get("OpenAI"),
